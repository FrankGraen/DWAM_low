...
# parser.add_argument("--agent", type=str, default="SHAC", help="Name of the agent.")
...
if app_launcher._livestream >= 1:
    from isaacsim.core.utils.extensions import enable_extension  # type: ignore # noqa: PLC0415
    app_launcher.app.set_setting("/app/window/drawMouse", True)  # noqa: FBT003
...
def train():
    ...
    if args_cli.checkpoint is not None:
        print(f"[INFO]Loading model from the: {args_cli.checkpoint}")
        agent.load(args_cli.checkpoint)
        # with torch.no_grad():
        #     log_1_2 = math.log(1.2)
        #     agent.policy.log_std_parameter.add_(log_1_2)
