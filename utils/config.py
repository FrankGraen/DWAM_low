...
SKRL_CONFIG_FILE = {
    "BoxPushEnv-v0_PPO": os.path.join(ROBOT_LAB_ENVS_DATA_DIR, "skrl/configs/ppo.yaml"),
    "BoxPushEnv-v0_SHAC": os.path.join(ROBOT_LAB_ENVS_DATA_DIR, "skrl/configs/shac.yaml")
}
...
def parse_skrl_cfg(task_name) -> dict:
    ...
    try:
        config_file = SKRL_CONFIG_FILE[task_name]
    except KeyError:
