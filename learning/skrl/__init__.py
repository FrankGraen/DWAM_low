...
from learning.skrl.agents import SHAC_agent, PPO_agent, RPO_agent, SAC_agent, TD3_agent, TRPO_agent
...
def get_agent(
    ...
    """
    if agent == "SHAC":
        return SHAC_agent(experiment_cfg, observation_space, action_space, env, conv)
    if agent == "PPO":
